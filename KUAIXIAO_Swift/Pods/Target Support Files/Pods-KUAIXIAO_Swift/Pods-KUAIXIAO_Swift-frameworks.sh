...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SJProgressHUD/SJProgressHUD.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SexyJson/SexyJson.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftyJSON/SwiftyJSON.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WHC_Layout/WHC_Layout.framework"
fi
